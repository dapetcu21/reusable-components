...
var electionApi = require('./electionApi-3ea2143e.js');
...
var ElectionResultsSummarySection = themable("ElectionResultsSummarySection", cssClasses$e, defaultConstants$3)((_ref) => {
  ...
  }, !fullWidthMap && results && /*#__PURE__*/React__default['default'].createElement(ElectionResultsSummaryTable, {
...
var useElectionScopePickerApi = (api, scope) => {
  ...
  var countyData = electionApi.useApiResponse(() => shouldQueryCounty ? api.getCounties() : null, [api, shouldQueryCounty]);
  var queryCountyId = (_ref = scope.type === "locality" ? scope.countyId : null) !== null && _ref !== void 0 ? _ref : null;
  var localityData = electionApi.useApiResponse(() => queryCountyId != null ? {
  ...
  var countryData = electionApi.useApiResponse(() => shouldQueryCountry ? api.getCountries() : null, [api, shouldQueryCountry]);
  return {
    countyData,
    localityData,
    countryData
...
exports.useApiResponse = electionApi.useApiResponse;
