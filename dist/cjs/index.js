...
var electionApi = require('./electionApi-ac0a3919.js');
...
var themable = (componentName, componentClasses, componentValues) => {
  return Component => {
    return /*#__PURE__*/React.forwardRef(function WrappedComponent(props, ref) {
      var theme = useTheme();
      var classes = React.useMemo(() => mergeThemeClasses(theme, componentName, componentClasses, props.classes, props.className), [theme, props.classes, props.className]);
      var constants = React.useMemo(() => mergeThemeConstants(theme, componentName, componentValues, props.constants), [theme, props.constants]);
...
function useApiResponse(makeInvocation, dependencies) {
  var _useState = React.useState({
    ...
    error: null
      ...
      _useState2 = electionApi._slicedToArray(_useState, 2),
      state = _useState2[0],
...
var useBallotData = function useBallotData(api, ballotId, scope) {
  var autoRefreshInterval = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : 60 * 1000;

  var _useState = React.useState(false),
      _useState2 = electionApi._slicedToArray(_useState, 2),
      timerToken = _useState2[0],
      setTimerToken = _useState2[1];

  var state = useApiResponse(() => ballotId != null && scope ? api.getBallot(ballotId, scope) : null, [scope, ballotId, timerToken]); // Changing the timerToken will re-trigger useApiResponse

  React.useEffect(() => {
    var _state$data;

    if (state.loading || !((_state$data = state.data) === null || _state$data === void 0 ? void 0 : _state$data.meta.live)) {
      return undefined;
    }
...
function styleInject(css) {
  ...
  if (insertAfter == null) {
    ...
    for (var i = 0; i < headNodes.length; i++) {
      ...
      if (node.nodeType === Node.COMMENT_NODE) {
        ...
        if (((_node$nodeValue = node.nodeValue) === null || _node$nodeValue === void 0 ? void 0 : _node$nodeValue.trim()) === "code4ro-style-inject") {
          insertAfter = node;
          break;
        }
      }
  ...
  if (insertAfter) {
    var sibling = insertAfter.nextSibling;

    if (sibling) {
      var _insertAfter$parentNo;

      (_insertAfter$parentNo = insertAfter.parentNode) === null || _insertAfter$parentNo === void 0 ? void 0 : _insertAfter$parentNo.insertBefore(style, sibling);
    } else {
      var _insertAfter$parentNo2;

      (_insertAfter$parentNo2 = insertAfter.parentNode) === null || _insertAfter$parentNo2 === void 0 ? void 0 : _insertAfter$parentNo2.appendChild(style);
    }
...
function makeTypographyComponent(Component, className, extraClassName) {
  ...
  React.forwardRef(function TypographyInner(_ref, ref) {
    ...
    return /*#__PURE__*/React__default['default'].createElement(Component_, Object.assign({}, otherProps, {
...
React.forwardRef( // eslint-disable-next-line @typescript-eslint/no-unused-vars
(_ref, forwardedRef) => {
  var classes = _ref.classes,
...
var PartyResultCard = themable("PartyResultCard", cssClasses$3)((_ref) => {
  ...
  }, /*#__PURE__*/React__default['default'].createElement(DivBodyMedium, {
    className: classes.nameRow
  }, /*#__PURE__*/React__default['default'].createElement(ColoredSquare, {
    className: classes.square,
    color: color
  }), /*#__PURE__*/React__default['default'].createElement("div", {
    className: classes.name
  }, name)), /*#__PURE__*/React__default['default'].createElement(DivHeading1, {
...
var PartyResultInline = themable("PartyResultInline", cssClasses$4)((_ref) => {
  var classes = _ref.classes,
      ...
      percentage = _ref.percentage,
      votes = _ref.votes;
  return /*#__PURE__*/React__default['default'].createElement(DivBody, {
    className: classes.root
  }, /*#__PURE__*/React__default['default'].createElement(ColoredSquare, {
    color: color,
    className: classes.square
    ...
    className: classes.name
  }, name), /*#__PURE__*/React__default['default'].createElement(Label, {
...
var HorizontalStackedBar = themable("PercentageBars", cssClasses$5)((_ref) => {
  ...
  return /*#__PURE__*/React__default['default'].createElement("div", {
    ...
    strokeWidth: 1.5,
    stroke: "#443F46"
  })), labelLeft != null && /*#__PURE__*/React__default['default'].createElement(DivBody, {
    className: classes.labelLeft
  }, labelLeft), labelRight != null && /*#__PURE__*/React__default['default'].createElement(DivBody, {
...
var PercentageBarsLegend = themable("PercentageBarsLegend", cssClasses$7)((_ref) => {
  ...
  return /*#__PURE__*/React__default['default'].createElement("div", {
    ...
    return /*#__PURE__*/React__default['default'].createElement(DivBody, {
      ...
      className: classes.name
    }, item.legendName), exists((_item$legendValueLabe = item.legendValueLabel) !== null && _item$legendValueLabe !== void 0 ? _item$legendValueLabe : item.valueLabel) && /*#__PURE__*/React__default['default'].createElement(React__default['default'].Fragment, null, " - ", /*#__PURE__*/React__default['default'].createElement("span", {
      className: classes.valueLabel
    }, (_item$legendValueLabe2 = item.legendValueLabel) !== null && _item$legendValueLabe2 !== void 0 ? _item$legendValueLabe2 : item.valueLabel)), exists(item.legendNote) && /*#__PURE__*/React__default['default'].createElement(React__default['default'].Fragment, null, " ", /*#__PURE__*/React__default['default'].createElement("span", {
...
var BarChart = themable("BarChart", undefined, defaultConstants)((_ref) => {
  ...
  for (var i = 0; i <= yGridSteps; i++) {
    ...
    labels.push( /*#__PURE__*/React__default['default'].createElement("text", {
      key: i,
      textAnchor: "end",
      x: width,
      y: y - 2,
...
var loadHereMaps = /*#__PURE__*/function () {
  var _ref = electionApi._asyncToGenerator( /*#__PURE__*/electionApi._regeneratorRuntime.mark(function _callee() {
    return electionApi._regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
...
var HereMapsAPIKeyContext = /*#__PURE__*/React.createContext("");
...
var HereMap = themable("HereMap", cssClasses$9, defaultValues)((_ref2) => {
  ...
  var H = useHereMaps();
  var apiKey = React.useContext(HereMapsAPIKeyContext);
  var mapRef = React.useRef(null);

  var _useState3 = React.useState(null),
      _useState4 = electionApi._slicedToArray(_useState3, 2),
      map = _useState4[0],
      setMap = _useState4[1];

  var featureStyles = React.useMemo(() => H && {
...
function _objectSpread(target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i] != null ? arguments[i] : {}; if (i % 2) { ownKeys(Object(source), true).forEach(function (key) { electionApi._defineProperty(target, key, source[key]); }); } else if (Object.getOwnPropertyDescriptors) { Object.defineProperties(target, Object.getOwnPropertyDescriptors(source)); } else { ownKeys(Object(source)).forEach(function (key) { Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key)); }); } } return target; }

var RomaniaMap = function RomaniaMap(props) {
  return /*#__PURE__*/React__default['default'].createElement("svg", props, /*#__PURE__*/React__default['default'].createElement("g", {
    fill: "#FFDC01"
...
var ElectionMap = themable("ElectionMap", cssClasses$8)((_ref) => {
  ...
  var _useDimensions = useDimensions(),
      _useDimensions2 = electionApi._slicedToArray(_useDimensions, 2),
  ...
  var _useMemo = React.useMemo(() => {
    if (scope.type === "locality" && scope.countyId != null) {
      ...
      return ["".concat(electionApi.electionMapOverlayUrl, "/localities_").concat(scope.countyId, ".geojson"), (_scope$localityId = scope.localityId) !== null && _scope$localityId !== void 0 ? _scope$localityId : null, localityId => _objectSpread(_objectSpread({}, scope), {}, {
        localityId
      })];
    }
    ...
    if (scope.type === "locality" && scope.countyId == null || scope.type === "county") {
      ...
      return ["".concat(electionApi.electionMapOverlayUrl, "/counties.geojson"), (_scope$countyId = scope.countyId) !== null && _scope$countyId !== void 0 ? _scope$countyId : null, countyId => _objectSpread(_objectSpread({}, scope), {}, {
        countyId
      })];
    }

    if (scope.type === "diaspora" || scope.type === "diaspora_country") {
      return ["".concat(electionApi.electionMapOverlayUrl, "/diaspora_countries.geojson"), scope.type === "diaspora_country" && scope.countryId != null ? scope.countryId : null, countryId => ({
        type: "diaspora_country",
        countryId
      })];
    }

    return ["".concat(electionApi.electionMapOverlayUrl, "/dobrogea.geojson"), null, countyId => ({
      type: "county",
      countyId
    })];
  }, [scope]),
      _useMemo2 = electionApi._slicedToArray(_useMemo, 3),
      overlayUrl = _useMemo2[0],
      selectedFeature = _useMemo2[1],
      scopeModifier = _useMemo2[2];

  var onFeatureSelect = React.useMemo(() => onScopeChange && (featureId => {
  ...
  }, showsSimpleMap ? /*#__PURE__*/React__default['default'].createElement("div", {
  ...
  }, /*#__PURE__*/React__default['default'].createElement(RomaniaMap, {
    className: classes.staticMapRomania
  }), children), involvesDiaspora && /*#__PURE__*/React__default['default'].createElement("div", {
  ...
  }, "Diaspora"), /*#__PURE__*/React__default['default'].createElement(WorldMap, {
    className: classes.staticMapWorld
  }))) : width > 0 && height > 0 && /*#__PURE__*/React__default['default'].createElement(HereMap, {
...
var ElectionTurnoutBars = themable("ElectionTurnoutBars")((_ref) => {
  ...
  return /*#__PURE__*/React__default['default'].createElement("div", {
    className: classes.root
  }, /*#__PURE__*/React__default['default'].createElement(PercentageBars, {
    total: 1,
    items: items
  }), /*#__PURE__*/React__default['default'].createElement(PercentageBarsLegend, {
    items: items
  }));
});
...
var ElectionTurnoutBreakdownChart = themable("ElectionTurnoutBreakdownChart", cssClasses$b)((_ref) => {
  ...
  }, type !== "all" && /*#__PURE__*/React__default['default'].createElement("div", {
    className: classes.infoRow
  }, /*#__PURE__*/React__default['default'].createElement("div", {
    className: classes.typeLabel
  }, breakdownTypeLabels[value.type]), /*#__PURE__*/React__default['default'].createElement("div", {
    className: classes.mapIconContainer
  }, type === "diaspora" && /*#__PURE__*/React__default['default'].createElement(WorldMap$1, {
    className: classes.worldMapIcon
  }), type === "national" && /*#__PURE__*/React__default['default'].createElement(RomaniaMap$1, {
...
var ElectionScopeIncompleteWarning = (_ref) => {
  var className = _ref.className,
      ...
      page = _ref.page;
  return completeness.complete ? null : /*#__PURE__*/React__default['default'].createElement(DivBodyHuge, {
    className: className
  }, "Pentru a vizualiza ", pageName(page), ", te rug\u0103m s\u0103 selectezi ", /*#__PURE__*/React__default['default'].createElement(Underlined, null, missingData(completeness)), ".");
};
...
var ElectionTurnoutSection = themable("ElectionTurnoutSection", cssClasses$c, defaultConstants$1)((_ref) => {
  ...
  var meta = _ref.meta,
      ...
      classes = _ref.classes,
      constants = _ref.constants;
  var involvesDiaspora = !!meta && electionTypeInvolvesDiaspora(meta.type);
  ...
  var map = width != null && /*#__PURE__*/React__default['default'].createElement(ElectionMap, {
    scope: scope,
    involvesDiaspora: involvesDiaspora,
    className: classes.map
  }, scope.type === "national" && turnout && turnout.eligibleVoters && /*#__PURE__*/React__default['default'].createElement("div", {
    className: classes.mapOverlay
  }, /*#__PURE__*/React__default['default'].createElement("div", {
    className: classes.mapOverlayPercentage
  }, formatPercentage(turnout.totalVotes / turnout.eligibleVoters)), /*#__PURE__*/React__default['default'].createElement("div", {
  ...
  return /*#__PURE__*/React__default['default'].createElement(React__default['default'].Fragment, null, mobileMap && map, showHeading && /*#__PURE__*/React__default['default'].createElement(React__default['default'].Fragment, null, /*#__PURE__*/React__default['default'].createElement(Heading2, null, "Prezen\u021Ba la vot"), /*#__PURE__*/React__default['default'].createElement("div", null, /*#__PURE__*/React__default['default'].createElement(Label, null, getScopeName(scope)))), !completeness.complete && /*#__PURE__*/React__default['default'].createElement(ElectionScopeIncompleteWarning, {
    className: classes.warning,
    completeness: completeness,
    page: "turnout"
  }), turnout == null && completeness.complete && /*#__PURE__*/React__default['default'].createElement(DivBodyHuge, {
    className: classes.warning
  }, "Nu exist\u0103 date despre prezen\u021Ba la vot pentru acest nivel de detaliu."), turnout && turnout.eligibleVoters != null && /*#__PURE__*/React__default['default'].createElement(ElectionTurnoutBars, {
  ...
  }, turnout && completeness.complete && (((_turnout$breakdown$le = (_turnout$breakdown = turnout.breakdown) === null || _turnout$breakdown === void 0 ? void 0 : _turnout$breakdown.length) !== null && _turnout$breakdown$le !== void 0 ? _turnout$breakdown$le : 0) > 0 || turnout.eligibleVoters == null) && /*#__PURE__*/React__default['default'].createElement("div", {
    className: classes.breakdownContainer
  }, turnout.eligibleVoters == null && /*#__PURE__*/React__default['default'].createElement("div", {
    className: mergeClasses(classes.breakdown, classes.totalVotesContainer)
  }, /*#__PURE__*/React__default['default'].createElement(BallotCheckmark, null), /*#__PURE__*/React__default['default'].createElement("div", {
    className: classes.totalVotesLabels
  }, /*#__PURE__*/React__default['default'].createElement("div", {
    className: classes.totalVotesCount
  }, formatGroupedNumber(turnout.totalVotes)), /*#__PURE__*/React__default['default'].createElement("div", {
    className: classes.totalVotesLabel
  }, "Votan\u021Bi ", getScopeName(scope)))), (_turnout$breakdown2 = turnout.breakdown) === null || _turnout$breakdown2 === void 0 ? void 0 : _turnout$breakdown2.map((breakdown, index) => /*#__PURE__*/React__default['default'].createElement(ElectionTurnoutBreakdownChart, {
    key: index,
...
var ShowcaseItem = (_ref) => {
  ...
  }, formatGroupedNumber(value)), /*#__PURE__*/React__default['default'].createElement(DivBodyLarge, {
...
var ElectionObservationSection = themable("ElectionObservationSection", cssClasses$d)((_ref2) => {
  ...
  return /*#__PURE__*/React__default['default'].createElement("div", {
    className: classes.root
  }, /*#__PURE__*/React__default['default'].createElement(Heading2, null, "Observarea independent\u0103 a alegerilor"), /*#__PURE__*/React__default['default'].createElement(DivBodyLarge, null, "Aceste date sunt colectate prin aplica\u021Bia", " ", /*#__PURE__*/React__default['default'].createElement("a", {
    href: "https://monitorizarevot.ro",
    target: "_blank",
    rel: "noreferrer"
  }, "Monitorizare Vot"), ", dezvoltat\u0103 de", " ", /*#__PURE__*/React__default['default'].createElement("a", {
    href: "https://code4.ro",
    target: "_blank",
    rel: "noreferrer"
  }, "Code for Romania"), ", de la observatorii independen\u021Bi acredita\u021Bi \xEEn sec\u021Biile de votare acoperite."), /*#__PURE__*/React__default['default'].createElement("div", {
    className: classes.showcase
  }, /*#__PURE__*/React__default['default'].createElement(ShowcaseItem, {
    classes: classes,
    icon: /*#__PURE__*/React__default['default'].createElement(BallotDrop, null),
    value: observation.coveredPollingPlaces
  }, "Sec\u021Bii de votare acoperite"), /*#__PURE__*/React__default['default'].createElement(ShowcaseItem, {
    classes: classes,
    icon: /*#__PURE__*/React__default['default'].createElement(RomaniaCountyMap, null),
    value: observation.coveredCounties
  }, "Jude\u021Be acoperite"), /*#__PURE__*/React__default['default'].createElement(ShowcaseItem, {
    classes: classes,
    icon: /*#__PURE__*/React__default['default'].createElement(RaisedHands, null),
    value: observation.observerCount
  }, "Observatori loga\u021Bi \xEEn aplica\u021Bie")), /*#__PURE__*/React__default['default'].createElement(PercentageBars, {
    items: items
  }), /*#__PURE__*/React__default['default'].createElement(PercentageBarsLegend, {
    items: items
  }));
...
var ElectionResultsStackedBar = themable("ElectionResultsStackedBar", cssClasses$f, defaultConstants$2)((_ref) => {
  ...
  var _useMemo = React.useMemo(() => {
    ...
    return [stackItems, items];
      ...
      _useMemo2 = electionApi._slicedToArray(_useMemo, 2),
  ...
  }, stackedBarItems.map((item, index) => (width >= breakpoint2 || item.index < 2) && /*#__PURE__*/React__default['default'].createElement(PartyResultCard, {
    key: item.index,
    name: item.name,
    color: item.color,
  ...
  }))), /*#__PURE__*/React__default['default'].createElement(HorizontalStackedBar, {
    items: stackedBarItems
  }), /*#__PURE__*/React__default['default'].createElement("div", {
    className: classes.legend
  }, legendItems.map(item => /*#__PURE__*/React__default['default'].createElement(PartyResultInline, {
    key: item.index,
...
var ElectionResultsSummaryTable = themable("ElectionResultsSummaryTable", cssClasses$g)((_ref) => {
  ...
  }, meta.ballot && /*#__PURE__*/React__default['default'].createElement(DivBody, null, meta.title), /*#__PURE__*/React__default['default'].createElement(Heading3, null, meta.ballot || meta.title, " ", dateFns.lightFormat(dateFns.parseISO(meta.date), "yyyy"))), /*#__PURE__*/React__default['default'].createElement("div", {
    className: classes.tableContainer
  }, /*#__PURE__*/React__default['default'].createElement("table", {
    className: classes.table
  }, /*#__PURE__*/React__default['default'].createElement("thead", null, /*#__PURE__*/React__default['default'].createElement("tr", null, /*#__PURE__*/React__default['default'].createElement(THeadRow, null, "Partid"), hasSeats && /*#__PURE__*/React__default['default'].createElement(THeadRow, null, "Mand."), /*#__PURE__*/React__default['default'].createElement(THeadRow, null, "Voturi"), /*#__PURE__*/React__default['default'].createElement(THeadRow, {
    className: classes.percentage
  }, "%"), /*#__PURE__*/React__default['default'].createElement(THeadRow, null))), /*#__PURE__*/React__default['default'].createElement("tbody", null, results.candidates.map((candidate, index) => /*#__PURE__*/React__default['default'].createElement("tr", {
    key: index
  }, /*#__PURE__*/React__default['default'].createElement(TCell, {
    className: classes.name
  }, /*#__PURE__*/React__default['default'].createElement(ColoredSquare, {
    color: electionCandidateColor(candidate),
    className: classes.square
  }), candidate.shortName || candidate.name), hasSeats && /*#__PURE__*/React__default['default'].createElement(TCell, null, candidate.seats != null && formatGroupedNumber(candidate.seats)), /*#__PURE__*/React__default['default'].createElement(TCell, null, formatGroupedNumber(candidate.votes)), /*#__PURE__*/React__default['default'].createElement(TCell, {
    className: classes.percentage
  }, formatPercentage(fractionOf(candidate.votes, results.validVotes))), /*#__PURE__*/React__default['default'].createElement("td", {
...
var ElectionResultsSummarySection = themable("ElectionResultsSummarySection", cssClasses$e, defaultConstants$3)((_ref) => {
  ...
  return /*#__PURE__*/React__default['default'].createElement(React__default['default'].Fragment, null, mobileMap && map, mobileMap && showHeading && separator, showHeading && /*#__PURE__*/React__default['default'].createElement(React__default['default'].Fragment, null, /*#__PURE__*/React__default['default'].createElement(Heading2, null, "Rezultate vot"), /*#__PURE__*/React__default['default'].createElement("div", null, /*#__PURE__*/React__default['default'].createElement(Label, null, getScopeName(scope)))), !completeness.complete && /*#__PURE__*/React__default['default'].createElement(ElectionScopeIncompleteWarning, {
    className: classes.warning,
    completeness: completeness,
    page: "results"
  }), results == null && completeness.complete && /*#__PURE__*/React__default['default'].createElement(DivBodyHuge, {
    className: classes.warning
  }, "Nu exist\u0103 date despre prezen\u021Ba la vot pentru acest nivel de detaliu."), results && /*#__PURE__*/React__default['default'].createElement(ElectionResultsStackedBar, {
    ...
    ref: measureRef
  }), results && !mobileMap && separator, !mobileMap && /*#__PURE__*/React__default['default'].createElement("div", {
    className: classes.mapSummaryContainer
  }, !fullWidthMap && meta && results && /*#__PURE__*/React__default['default'].createElement(ElectionResultsSummaryTable, {
...
var DecorativeIcon = () => /*#__PURE__*/React__default['default'].createElement("path", {
...
var SeatsGraphic = /*#__PURE__*/React.memo(function SeatsGraphicUnmemoized(_ref) {
  var classes = _ref.classes,
      results = _ref.results,
      width = _ref.width,
      height = _ref.height,
  ...
  var r = React.useMemo(() => 45.345892868 / Math.sqrt(totalSeats), [totalSeats]);
  ...
  var onDeselect = React.useCallback(() => {
  ...
  return /*#__PURE__*/React__default['default'].createElement("svg", {
    ...
    stroke: "transparent",
    onMouseLeave: onDeselect
  }), dots.map((dot, index) => /*#__PURE__*/React__default['default'].createElement("circle", {
    key: index,
    r: r,
  ...
  }, /*#__PURE__*/React__default['default'].createElement(DecorativeIcon, null)), /*#__PURE__*/React__default['default'].createElement("text", {
    x: 100,
    y: 85,
...
var ElectionResultsSeats = themable("ElectionResultsSeats", cssClasses$h, defaultConstants$4)((_ref2) => {
  ...
  return /*#__PURE__*/React__default['default'].createElement("div", {
    ...
    return Number.isFinite(candidate.seats) && candidate.seats != null && candidate.seats > 0 ? /*#__PURE__*/React__default['default'].createElement(DivBody, {
      className: classes.legendItem,
      key: index
    }, /*#__PURE__*/React__default['default'].createElement(ColoredSquare, {
      className: classes.square,
    ...
    }, (_candidate$shortName = candidate.shortName) !== null && _candidate$shortName !== void 0 ? _candidate$shortName : candidate.name), /*#__PURE__*/React__default['default'].createElement(DivLabel, {
      className: classes.legendValue
    }, "\xA0(", formatGroupedNumber(candidate.seats), ")")) : null;
  })), /*#__PURE__*/React__default['default'].createElement("div", {
    className: classes.svgContainer
  }, /*#__PURE__*/React__default['default'].createElement(SeatsGraphic, {
    classes: classes,
    results: results,
    width: svgWidth,
    height: svgHeight,
...
var CandidateTable = (_ref) => {
  ...
  var onToggleCollapsed = React.useCallback(() => {
    setCollapsed(x => !x);
  }, []);
  return /*#__PURE__*/React__default['default'].createElement("div", {
    className: classes.tableContainer
  }, /*#__PURE__*/React__default['default'].createElement(ResultsTable, {
    className: classes.table
  }, /*#__PURE__*/React__default['default'].createElement("thead", null, /*#__PURE__*/React__default['default'].createElement("tr", null, /*#__PURE__*/React__default['default'].createElement("th", null, "Partid / Alian\u021B\u0103 / Candidat independent"), hasCandidateCount && /*#__PURE__*/React__default['default'].createElement("th", null, "Nr. cand."), /*#__PURE__*/React__default['default'].createElement("th", null, "Voturi"), /*#__PURE__*/React__default['default'].createElement("th", null, "%"), hasSeats && /*#__PURE__*/React__default['default'].createElement("th", null, "Mandate"), hasSeatsGained && /*#__PURE__*/React__default['default'].createElement("th", null, "+/-"))), /*#__PURE__*/React__default['default'].createElement("tbody", null, candidates.map((candidate, index) => (!(canCollapse && collapsed) || index < 5) && /*#__PURE__*/React__default['default'].createElement("tr", {
    key: index
  }, /*#__PURE__*/React__default['default'].createElement("td", {
    className: classes.nameCell
  }, candidate.name), hasCandidateCount && /*#__PURE__*/React__default['default'].createElement("th", null, formatGroupedNumber(candidate.candidateCount || 0)), /*#__PURE__*/React__default['default'].createElement("td", null, formatGroupedNumber(candidate.votes)), /*#__PURE__*/React__default['default'].createElement("td", null, formatPercentage(fractionOf(candidate.votes, validVotes))), hasSeats && /*#__PURE__*/React__default['default'].createElement("td", null, formatGroupedNumber(candidate.seats || 0)), hasSeatsGained && /*#__PURE__*/React__default['default'].createElement("td", null, typeof candidate.seatsGained === "number" ? formatGroupedNumber(candidate.seatsGained) : candidate.seatsGained === "new" ? "Nou" : candidate.seatsGained))))), canCollapse && /*#__PURE__*/React__default['default'].createElement(Button, {
...
var ElectionResultsTableSection = themable("ElectionResultsTableSection", cssClasses$i)((_ref2) => {
  ...
  if (unqualified && unqualified.length > 0) {
    return /*#__PURE__*/React__default['default'].createElement(React__default['default'].Fragment, null, /*#__PURE__*/React__default['default'].createElement(Heading2, {
      className: classes.heading
    }, "Partide care au \xEEndeplinit pragul electoral"), /*#__PURE__*/React__default['default'].createElement(CandidateTable, {
      classes: classes,
      ...
      className: classes.heading
    }, "Partide care nu au \xEEndeplinit pragul electoral"), /*#__PURE__*/React__default['default'].createElement(CandidateTable, {
      classes: classes,
  ...
  return /*#__PURE__*/React__default['default'].createElement(CandidateTable, {
    classes: classes,
    candidates: qualified,
    hasSeats: hasSeats,
    validVotes: results.validVotes
...
var ShowcaseItem$1 = (_ref) => {
  ...
  return /*#__PURE__*/React__default['default'].createElement("div", {
    ...
    className: classes.showcaseValue
  }, formatGroupedNumber(value)), /*#__PURE__*/React__default['default'].createElement(DivBodyHuge, {
    className: classes.showcaseText
  }, children)));
};
...
var ElectionResultsProcess = themable("ElectionResultsProcess", cssClasses$j)((_ref2) => {
  ...
  return /*#__PURE__*/React__default['default'].createElement("div", {
    className: classes.root
  }, results.eligibleVoters != null && /*#__PURE__*/React__default['default'].createElement(ShowcaseItem$1, {
    classes: classes,
    icon: /*#__PURE__*/React__default['default'].createElement(Citizens, null),
    value: results.eligibleVoters
  }, "Total aleg\u0103tori \xEEnscri\u0219i \xEEn liste"), results.votesByMail != null && /*#__PURE__*/React__default['default'].createElement(ShowcaseItem$1, {
    classes: classes,
    icon: /*#__PURE__*/React__default['default'].createElement(VoteByMail, null),
    value: results.votesByMail
  }, "Total voturi prin coresponden\u021B\u0103"), /*#__PURE__*/React__default['default'].createElement(ShowcaseItem$1, {
    classes: classes,
    icon: /*#__PURE__*/React__default['default'].createElement(CitizensBuilding, null),
    value: results.totalVotes
  }, "Total aleg\u0103tori prezen\u021Bi la urne"), /*#__PURE__*/React__default['default'].createElement(ShowcaseItem$1, {
    classes: classes,
    icon: /*#__PURE__*/React__default['default'].createElement(BallotFillIn, null),
    value: results.validVotes
  }, "Total voturi valabil exprimate"), /*#__PURE__*/React__default['default'].createElement(ShowcaseItem$1, {
    classes: classes,
    icon: /*#__PURE__*/React__default['default'].createElement(NullTimes, null),
...
var dateComparator = (a, b) => {
  return dateFns.parseISO(b.date).getTime() - dateFns.parseISO(a.date).getTime();
};
...
var ElectionTimeline = themable("ElectionTimeline", cssClasses$k)((_ref) => {
  ...
  var years = React.useMemo(() => {
    ...
    sortedItems.forEach(meta => {
      var metaYear = dateFns.parseISO(meta.date).getFullYear();
  ...
  var _useMemo = React.useMemo(() => {
    ...
    return [meta.electionId, dateFns.parseISO(meta.date).getFullYear()];
  ...
  return /*#__PURE__*/React__default['default'].createElement("div", {
    className: classes.root
  }, years.map(year => /*#__PURE__*/React__default['default'].createElement("div", {
    key: year.year,
    className: classes.year
  }, /*#__PURE__*/React__default['default'].createElement("div", {
    className: mergeClasses(classes.yearRow, selectedYear === year.year && classes.selectedYear)
  }, year.year), year.elections.map(election => /*#__PURE__*/React__default['default'].createElement("div", {
  ...
  }, election.ballots.length > 1 && /*#__PURE__*/React__default['default'].createElement("svg", {
  ...
  }, election.title), election.live && /*#__PURE__*/React__default['default'].createElement("div", {
    className: classes.live
  }, "LIVE")), expandedElections.has(election.electionId) && election.ballots.length >= 2 && election.ballots.map((meta, index) => /*#__PURE__*/React__default['default'].createElement("div", {
    key: meta.ballotId,
  ...
  }, meta.ballot || "".concat(meta.title, " ").concat(index + 1)))))), /*#__PURE__*/React__default['default'].createElement("div", {
...
function _objectSpread$1(target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i] != null ? arguments[i] : {}; if (i % 2) { ownKeys$1(Object(source), true).forEach(function (key) { electionApi._defineProperty(target, key, source[key]); }); } else if (Object.getOwnPropertyDescriptors) { Object.defineProperties(target, Object.getOwnPropertyDescriptors(source)); } else { ownKeys$1(Object(source)).forEach(function (key) { Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key)); }); } } return target; }
...
var useElectionScopePickerGetSelectProps = (apiData, scope, onChangeScope) => {
  var countyMap = React.useMemo(() => buildMap(apiData.countyData.data), [apiData.countyData.data]);
  var localityMap = React.useMemo(() => buildMap(apiData.localityData.data), [apiData.localityData.data]);
  var countryMap = React.useMemo(() => buildMap(apiData.countyData.data), [apiData.countryData.data]);
  var onCountyChange = React.useCallback(value => {
  ...
  var onLocalityChange = React.useCallback(value => {
  ...
  var onCountryChange = React.useCallback(value => {
...
var useElectionScopePickerGetTypeSelectProps = (scope, onChangeScope) => {
  var onTypeChange = React.useCallback(value => {
...
var typeSelectStyles = {
  // eslint-disable-next-line @typescript-eslint/no-explicit-any
  control: provided => _objectSpread$1(_objectSpread$1({}, provided), {}, {
    borderColor: "transparent",
    borderWidth: 0,
    cursor: "pointer"
  }),
  // eslint-disable-next-line @typescript-eslint/no-explicit-any
  valueContainer: provided => _objectSpread$1(_objectSpread$1({}, provided), {}, {
    fontWeight: 600,
...
var ElectionScopePicker = themable("ElectionScopePicker", cssClasses$l)((_ref5) => {
  ...
  var theme = useTheme();
  var selectTheme = React.useMemo( // eslint-disable-next-line @typescript-eslint/no-explicit-any
  () => t => _objectSpread$1(_objectSpread$1({}, t), {}, {
    colors: _objectSpread$1(_objectSpread$1({}, t.colors), {}, {
  ...
  return /*#__PURE__*/React__default['default'].createElement("div", {
    className: classes.root
  }, /*#__PURE__*/React__default['default'].createElement(Select__default['default'], Object.assign({}, typeSelect.selectProps, {
    isSearchable: false,
    ...
    }, label), /*#__PURE__*/React__default['default'].createElement(Select__default['default'], Object.assign({}, selectProps, {
      isClearable: true,
      getOptionLabel: getOptionLabel,
      getOptionValue: getOptionValue,
      theme: selectTheme,
...
exports.electionApiProductionUrl = electionApi.electionApiProductionUrl;
exports.electionMapOverlayUrl = electionApi.electionMapOverlayUrl;
exports.jsonFetch = electionApi.jsonFetch;
exports.makeElectionApi = electionApi.makeElectionApi;
exports.makeJsonFetch = electionApi.makeJsonFetch;
exports.mockFetch = electionApi.mockFetch;
exports.transformApiInvocation = electionApi.transformApiInvocation;
exports.BarChart = BarChart;
exports.Body = Body;
exports.BodyHuge = BodyHuge;
exports.BodyLarge = BodyLarge;
exports.BodyMedium = BodyMedium;
exports.Button = Button;
exports.ColoredSquare = ColoredSquare;
exports.DivBody = DivBody;
exports.DivBodyHuge = DivBodyHuge;
exports.DivBodyLarge = DivBodyLarge;
exports.DivBodyMedium = DivBodyMedium;
exports.DivHeading1 = DivHeading1;
exports.DivHeading2 = DivHeading2;
exports.DivHeading3 = DivHeading3;
exports.DivLabel = DivLabel;
exports.DivLabelMedium = DivLabelMedium;
exports.ElectionMap = ElectionMap;
exports.ElectionObservationSection = ElectionObservationSection;
exports.ElectionResultsProcess = ElectionResultsProcess;
exports.ElectionResultsSeats = ElectionResultsSeats;
exports.ElectionResultsStackedBar = ElectionResultsStackedBar;
exports.ElectionResultsSummarySection = ElectionResultsSummarySection;
exports.ElectionResultsSummaryTable = ElectionResultsSummaryTable;
exports.ElectionResultsTableSection = ElectionResultsTableSection;
exports.ElectionScopePicker = ElectionScopePicker;
exports.ElectionTimeline = ElectionTimeline;
exports.ElectionTurnoutSection = ElectionTurnoutSection;
exports.Heading1 = Heading1;
exports.Heading2 = Heading2;
exports.Heading3 = Heading3;
exports.HereMap = HereMap;
exports.HereMapsAPIKeyContext = HereMapsAPIKeyContext;
exports.HereMapsAPIKeyProvider = HereMapsAPIKeyProvider;
exports.HorizontalStackedBar = HorizontalStackedBar;
exports.Label = Label;
exports.LabelMedium = LabelMedium;
exports.PartyResultCard = PartyResultCard;
exports.PartyResultInline = PartyResultInline;
exports.PercentageBars = PercentageBars;
exports.PercentageBarsLegend = PercentageBarsLegend;
exports.ResultsTable = ResultsTable;
exports.ThemeProvider = ThemeProvider;
exports.Underlined = Underlined;
exports.electionHasSeats = electionHasSeats;
exports.electionScopeIsComplete = electionScopeIsComplete;
exports.electionScopePickerUpdateType = electionScopePickerUpdateType;
exports.electionTypeHasSeats = electionTypeHasSeats;
exports.electionTypeInvolvesDiaspora = electionTypeInvolvesDiaspora;
exports.makeTypographyComponent = makeTypographyComponent;
exports.mergeClasses = mergeClasses;
exports.mergeThemeClasses = mergeThemeClasses;
exports.mergeThemeConstants = mergeThemeConstants;
exports.overrideClasses = overrideClasses;
exports.romaniaMapBounds = romaniaMapBounds;
exports.themable = themable;
exports.useApiResponse = useApiResponse;
exports.useBallotData = useBallotData;
exports.useElectionScopePickerApi = useElectionScopePickerApi;
exports.useElectionScopePickerGetSelectProps = useElectionScopePickerGetSelectProps;
exports.useElectionScopePickerGetTypeSelectProps = useElectionScopePickerGetTypeSelectProps;
exports.useTheme = useTheme;
exports.worldMapBounds = worldMapBounds;
