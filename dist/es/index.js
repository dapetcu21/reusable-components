import { _ as _slicedToArray, a as _asyncToGenerator, b as _regeneratorRuntime, e as electionMapOverlayUrl, c as _defineProperty } from './electionApi-abd6e0f7.js';
export { g as electionApiProductionUrl, e as electionMapOverlayUrl, j as jsonFetch, f as makeElectionApi, m as makeJsonFetch, d as mockFetch, t as transformApiInvocation } from './electionApi-abd6e0f7.js';
...
var ElectionMap = themable("ElectionMap", cssClasses$8)((_ref) => {
  ...
  var _useMemo = useMemo(() => {
    if (scope.type === "locality" && scope.countyId != null) {
      ...
      return ["".concat(electionMapOverlayUrl, "/localities_").concat(scope.countyId, ".geojson"), (_scope$localityId = scope.localityId) !== null && _scope$localityId !== void 0 ? _scope$localityId : null, localityId => _objectSpread(_objectSpread({}, scope), {}, {
        localityId
      })];
    }
    ...
    if (scope.type === "locality" && scope.countyId == null || scope.type === "county") {
      ...
      return ["".concat(electionMapOverlayUrl, "/counties.geojson"), (_scope$countyId = scope.countyId) !== null && _scope$countyId !== void 0 ? _scope$countyId : null, countyId => _objectSpread(_objectSpread({}, scope), {}, {
        countyId
      })];
    }
...
var ElectionResultsSummarySection = themable("ElectionResultsSummarySection", cssClasses$e, defaultConstants$3)((_ref) => {
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, mobileMap && map, mobileMap && showHeading && separator, showHeading && /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(Heading2, null, "Rezultate vot"), /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement(Label, null, getScopeName(scope)))), !completeness.complete && /*#__PURE__*/React.createElement(ElectionScopeIncompleteWarning, {
    className: classes.warning,
    completeness: completeness,
    page: "results"
  ...
  }, !fullWidthMap && meta && results && /*#__PURE__*/React.createElement(ElectionResultsSummaryTable, {
...
export { BarChart, Body, BodyHuge, BodyLarge, BodyMedium, Button, ColoredSquare, DivBody, DivBodyHuge, DivBodyLarge, DivBodyMedium, DivHeading1, DivHeading2, DivHeading3, DivLabel, DivLabelMedium, ElectionMap, ElectionObservationSection, ElectionResultsProcess, ElectionResultsSeats, ElectionResultsStackedBar, ElectionResultsSummarySection, ElectionResultsSummaryTable, ElectionResultsTableSection, ElectionScopePicker, ElectionTimeline, ElectionTurnoutSection, Heading1, Heading2, Heading3, HereMap, HereMapsAPIKeyContext, HereMapsAPIKeyProvider, HorizontalStackedBar, Label, LabelMedium, PartyResultCard, PartyResultInline, PercentageBars, PercentageBarsLegend, ResultsTable, ThemeProvider, Underlined, electionHasSeats, electionScopeIsComplete, electionScopePickerUpdateType, electionTypeHasSeats, electionTypeInvolvesDiaspora, makeTypographyComponent, mergeClasses, mergeThemeClasses, mergeThemeConstants, overrideClasses, romaniaMapBounds, themable, useApiResponse, useBallotData, useElectionScopePickerApi, useElectionScopePickerGetSelectProps, useElectionScopePickerGetTypeSelectProps, useTheme, worldMapBounds };
